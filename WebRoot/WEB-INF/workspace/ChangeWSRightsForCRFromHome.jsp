...
function openlinkEdit(buttonName,workSpaceID,stageIds,userCode,nodeId){
	...
	$.ajax( {
		url:'RemoveAndUpdateRightsPopupForCRFromHomePage_ex.do?workSpaceID='+workSpaceID+'&stageIds='+stageIds+'&userCode='+userCode+'&nodeId='+nodeId+'&remark='+remark+'&RightsType='+modulewiserights+'&uCode='+uCode,
		beforeSend : function() {
...
<div align ="center">
	...
	<input type="submit" value="Change Rights" class="button" name="buttonName"
