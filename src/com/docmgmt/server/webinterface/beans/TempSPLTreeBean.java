 ...
 */
	public String getWorkspaceTreeHtml(String workspaceID,int userGroupCode,int userCode,File file){
		StringBuffer htmlSB = new StringBuffer();//new StringBuffer();
	...
	private StringBuffer getChildStructure(Integer nodeId, TreeMap childNodeHS, Hashtable nodeDtlHS) {
		...
		if(childList.size() > 0){
            ...
            htmlStringBuffer.append("<IMG id='folder" + nodeId.intValue() + "' src=\"images/closed.gif\"><a  href=\"SPLWorkspaceNodeRights.do?requestId="+ ClientRequestID.WORKSPACE_NODE_RIGHTS +"&nodeId="+nodeId+"&leaf=no\"" + " target=\"attributeFrame\" >" + displayName.replaceAll(" ","&nbsp;") + "</a><BR>\n");
            ...
            if(getUserType().equalsIgnoreCase("WU")) {
            	...
            	htmlStringBuffer.append("<IMG  src=\"images/empty.gif\"><a  href=\"SPLWorkspaceNodeRights.do?requestId="+ ClientRequestID.WORKSPACE_NODE_RIGHTS +"&nodeId="+nodeId+"&leaf=yes\"" + " target=\"attributeFrame\" >" + displayName.replaceAll(" ","&nbsp;") + "</a><BR>\n");
