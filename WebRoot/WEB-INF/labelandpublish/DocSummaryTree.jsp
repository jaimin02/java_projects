...
if(workspaceId==null || workspaceId.equals("-1"))
   ...
   if(modifyAfBf.equals("1")) { 
      				if(!checkDate.equals("")){
							...
							errorFlag = " Modify Date Not Selected....";
						} 
...
<table width="100%" border="0">
	<tr>
		<td align="right"><img alt="Back" title="Back"
			src="images/Common/Back.png" onclick="return goBack();">&nbsp;
	...
	<tr bgcolor="#FCE0E3" align="center">
		...
		<table bgcolor="#FCE0E3" width="100%">
			<tr>
				...
				<td width="75%" valign="middle" align="left"><b><font
