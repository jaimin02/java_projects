...
public class ChangeStatusForDocSign extends ActionSupport {
	...
	public Vector<DTOWorkSpaceUserRightsMst> stageuserdtl;
	...
	public String execute() {
		...
		stageuserdtl = docMgmtImpl.getStageUserDetailForDocSign(workspaceID,nodeId, userCode);
