...
<s:form action="SaveAttributeForESignature" method="post" enctype="multipart/form-data" name="saveAttribute" 
...
<div align ="center">
 ...
 <%-- </s:if> --%>
	<input type="button" value="Close" style="margin-left: 7px;" class="button" onclick="window.location='ESignature.do?docId=<s:property value="WorkspaceId"/>&docType=<s:property value="docType"/>';">
