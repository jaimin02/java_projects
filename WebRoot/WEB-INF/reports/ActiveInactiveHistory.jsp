...
<script type="text/javascript">
	...
	function getProjectSnapshot(reportType) {
		...
		var urlOfAction = "showSectionwiseActiveInactiveHistory_ex.do?mode=" + mode;//mode=1  for latest  
	...
	function subinfo() {
		...
		$
				.ajax({
					url : 'showSectionwiseActiveInactiveHistory_ex.do?workSpaceId='
							+ workSpaceId + '&mode=' + mode,
					beforeSend : function() {
						$('#ProjectSnapshotDiv')
								.html(
										"<img src=\"images/loading.gif\" alt=\"loading ...\" />");
		...
		$
				.ajax({
					...
					success : function(response) {
						...
						$('#AttrHistoryDiv')
								.html(
										"<div align='center' class='datatable' style=' overflow:auto;max-height:115px; width:400px;background:white;'>"
												+ response + "</div>");
					}
				});
...
<body>
	<div class="container-fluid">
		<div class="col-md-12">
			...
			<div class="boxborder">
				<div class="all_title">
					<b style="float: left">Active/Inactive History</b>
				</div>
			</div>
			<!-- <img
					...
					<table Style="width: 100%">
						<tr>
							...
							<td><s:select id="workSpaceId" name="workSpaceId"
									...
									onchange="getProjectSnapshot('TreeView')"
