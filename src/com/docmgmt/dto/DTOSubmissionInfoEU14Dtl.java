...
public class DTOSubmissionInfoEU14Dtl implements Serializable{
    ...
    List<DTOSubmissionInfoEU14SubDtl> cmsDtls;
	...
	public List<DTOSubmissionInfoEU14SubDtl> getCmsDtls() {
		return cmsDtls;
	}

	public void setCmsDtls(List<DTOSubmissionInfoEU14SubDtl> cmsDtls) {
