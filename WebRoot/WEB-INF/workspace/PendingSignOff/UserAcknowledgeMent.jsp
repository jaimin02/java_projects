...
<div style="border: 1px; border-radius: 10px 10px 0px 0px; border-color: #5A8AA9; border-style: solid; padding-bottom: 5px; border-top: none;"
	...
	<div class="boxborder"><div class="all_title"><b style="float: left;">User Acknowledgement</b></div>
<s:if test="userAcknowledge.size() == 0">
			<tr class="odd">
...
<div
	...
	align="left">
<table id="acknowledgement" class="datatable paddingtable audittrailtable" style="width:100%; overflow: auto; z-index: 1; align:center;">
	<thead>
		<tr style="margin: 0px; padding: 0px; font: bold 16px calibri;">
			 <th style="padding-left: 2px;">#</th> 
			<th title="Project">Project</th>
			<th width="25%" title="fileName">Acknowledgement</th>
		</tr>
	</thead>
	<tbody style="padding-right: 10px;">
			<s:iterator value="userAcknowledge" status="status1">
				...
				<tr class="<s:if test="#status1.even">even</s:if><s:else>odd</s:else>">
					...
					<td>
						<input type="image" title="Acknowledge" alt="Submit" src="images/Common/update_user.svg" height="25px" width="25px"
							onclick="return approvalofacknowledgement('<s:property value="workSpaceId" />','<s:property value="userCode" />');"  />	
					</td>
