...
<div style="border: 1px; border-radius: 10px 10px 0px 0px; border-color: #5A8AA9; border-style: solid; padding-bottom: 15px; border-top: none;"
	align="center">
<div class="boxborder"><div class="all_title"><b style="float:left">User Rights Removal History</b></div>
<!-- 	<div class="headercls" align="center" style="width: 100%">Workspace User Detail History</div> -->
<br>
<div class="grid_clr">
<table id = "deletedWorkspaceUserHistory" class="datatable paddingtable audittrailtable" width="98%" align="center">
	<thead>
		<tr>
			<th>#</th>
			<th>Project</th>
	...
	<tbody>
		<s:iterator value="deletedWorkspaceUserHistory" status="status">
			...
			<s:if test ="#session.countryCode != 'IND'">
				...
				<td><s:property value="stages" default="-" /></td>
