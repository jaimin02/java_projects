...
<div style="border: 1px; border-radius: 10px 10px 0px 0px; border-color: #5A8AA9; border-style: solid; padding-bottom: 15px; border-top: none;"
	...
	<div class="boxborder"><div class="all_title"><b style="float: left;">Application Detail History</b></div>
<br>
<div class="grid_clr">
<table id = "applicationDetailHistory" class="datatable paddingtable audittrailtable" width="98%" align="center">
	<thead>
		<tr>
			<th>#</th>
	...
	<tbody>
		<s:iterator value="applicationDetailHistory" status="status">
