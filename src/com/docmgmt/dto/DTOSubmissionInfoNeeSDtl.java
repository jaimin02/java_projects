...
public class DTOSubmissionInfoNeeSDtl implements Serializable{
	...
	public String getSubmissionInfoNeeSDtlId() {
		return submissionInfoNeeSDtlId;
	}

	public void setSubmissionInfoNeeSDtlId(String submissionInfoNeeSDtlId) {
		this.submissionInfoNeeSDtlId = submissionInfoNeeSDtlId;
	}
