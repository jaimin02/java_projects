	  					...
	  					<div class="right">
						    <p>
						       Name : <s:property value="uName"/><br>
	  					       ...
	  					       Sign Id : <s:property value="signId"/>
	  					      <s:if test="projectType=='0004' "> Action :
		  					       <s:if test="srFlag==''  && selectedStage=='Created' ">Created<!-- Created --></s:if>
		  					       <s:if test="selectedStage==10">Created</s:if>
		  					       <s:if test="selectedStage==20">Reviewed</s:if>  
		  					       <s:if test="selectedStage==100">Approved</s:if>
	  					       </s:if> 
		    				</p>
	  					</div>
					</div>
					 		 ...
					 		 success: function(data)
					 		 {
					 		 	if(data=="false"){
					 		 		$.ajax({
										  ...
										  +"&remark="+deviationRemark+"&stageId="+stageId+"&eSign="+eSign+"&xCordinates="+posizioneX
										  +"&yCordinates="+posizioneY+"&pageNo="+pageNo+"&actionDesc="+action+"&tranNo="+tranNo,
					 		 			success: function(data) 
										  {
											  //debugger;
