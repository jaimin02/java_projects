...
function openlinkEdit(buttonName,stageIds,userCode,nodeId){
	...
	$.ajax( {
		url:'RemoveAndUpdateRecordRights_ex.do?WorkspaceId='+wsId+'&stageIdForChange='+stageIds+'&userCodeForChange='+userCode+'&nodeIdForChange='+nodeId+'&remarkForChange='+remark+'&RightsType='+modulewiserights+'&uCodeByForChange='+uCode,
		beforeSend : function() {
