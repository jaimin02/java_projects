...
/**
 * Classe permettant de récupérer des mails sur un serveur Pop3 ou Imap4 (avec SSL ou non) <br>
 * les fichiers en attachement sont déposés sur un disk! <br>
 *   <br>
 ...
 *  <br> <br>
 * Le mot de passe du magasin global est par défaut : 'changeit' <br>
 *
 ***
 *
...
public class Pop3
{
  ...
  /**
   * Objet store lié à une session...
   */
  private Store store = null;

  /**
   * Objet folder lié à un store, (dossier INBOX par defaut)
   */
  private Folder folder = null;

  /**
   * Array Folder lié à un autre folder (liste sous dossier IMAP abonné ou non)
   */
  private Folder folders[] = null;

  /**
   * Array Folder, dossiers racines IMAP (liste dossiers racines IMAP abonné ou non)
   */
  private Folder defaut_folders[] = null;


  /**
   * Objet message lié à un folder...
   */
  ...
  /**
   * Constructeur, ne fait rien si aucune variable de classe n'est paramétrée!
   */
  public Pop3()
  {
  }
  ...
  public Pop3(String _dir, String _host, String _username, String _password, int _port, String _protocol)
  {
    ...
    // vérif du séparateur système!
    if (!c_dir.endsWith(a_sep)) c_dir+=a_sep;
  }

  /**
   * Méthode setDir, défini le dossier de destination des mails
   */
  ...
  /**
   * Méthode setHost, défini le server pop3
   */
  ...
  /**
   * Méthode setLogin, défini le login du compte pop3
   */
  ...
  /**
   * Méthode setPwd, défini le pwd du compte pop3
   */
  ...
  /**
   * Méthode setPort, défini le port du server pop3
   */
  ...
  */
  ...
  /**
   * Méthode getMail, récupère des mails simples et multiparts !
   *
  ...
  public Message[] getMail(String box, boolean sDebug) throws NoSuchProviderException, MessagingException
  {
      ...
      if (SSL)
      {
          ...
          if (c_protocol.equals(POP))    store = new POP3SSLStore(session, url);
          else if (c_protocol.equals(IMAP)) store = new IMAPSSLStore(session, url);
      ...
      {
          // liste tous les dossiers racine (ROOT abonné ou non...)
          Folder defaultFolder = store.getDefaultFolder();
          if (defaultFolder == null) throw new MessagingException("Can't find defaut FOLDER !!!");

          // récupère la liste des dossiers racines
          defaut_folders = defaultFolder.list();

          // récupère le séparateur de dossiers du serveur
          ...
          if (folder.exists())
          {
              ...
              // récupère les messages du dossier courant
              if (folder.isOpen())
              {
                  // récupère la liste des dossiers, imap uniquement
                  try { folders = folder.list(); }
  ...
  private Properties getSessionProperties() throws MessagingException
  {
      ...
      {
          // add new provider
          try { Security.addProvider(new com.sun.net.ssl.internal.ssl.Provider()); }
          catch (SecurityException se) { throw new MessagingException(""+se); }
  ...
  /**
   * Défini l'option de débuggage
   *
   * @param _debug   Booléan de l'option de débuggage
   */
  ...
  /**
   * Méthode close qui ferme une session pop3
   *
  ...
  {
    if (folder.isOpen()) folder.close(_del); // on efface les messages ou pas!
    store.close();
  }

  /**
   * Determine si la connexion au un serveur POP3 ou IMAP4 est sécurisée par SSL.
   *
  ...
  /**
   * Méthode isRead, ce message a été lu ?
   *
   * @param num Numéro du message
   * @throws MessagingException MessagingException Si une erreur survient.
   */
  ...
  /**
   * Méthode countMessage, compte tous les messages dans la box
   *
   * @param num Numéro du message
   * @throws MessagingException MessagingException Si une erreur survient.
   */
  ...
  /**
   * Crée un nouveau dossier IMAP de le dossier courant...
   *
   * @param _folder
   * @return bollean true si tout s'est bien passé
   * @throws MessagingException MessagingException Si une erreur survient.
   */
  ...
  /**
   * Détruit un Folder IMAP (ATTENTION permanent!)
   *
   * @param _folder
   * @return bollean true si tout s'est bien passé
   ...
   *
   * @param _srcFolder Dossier à renomer
  ...
  public boolean renameFolder(String _srcFolder, String _destFolder) throws MessagingException
  {
      ...
      if (sourceF.exists() && sourceF.isOpen() && createFolder(_destFolder))
      {
          ...
          if (targetF.exists() && targetF.isOpen())
          {
              ...
              // finallement on tente de détruit la source...
  ...
  /**
   * S'abonner ou se désabonner à un dossier IMAP (Subscrib / UnSubcrib Folder IMAP)
   *
   * @param _folder
   * @return
   * @throws MessagingException
  ...
  /**
   * Retourne tous les dossiers abonnés courants
   *
   * @return Folder[]
   */
  public Folder[] getSubscribedFolder()
  {
      ...
      ArrayList array = new ArrayList(); //auto size!
  ...
  /**
   * Retourne tous les dossiers non abonnés courants
   *
   * @return Folder[]
   */
  ...
  /**
     * Class interne gérant les types de fichier attaché à un mail
     */
  public final static class Tools
  {

      /**
         * Méthode saveFile, sauve un fichier sur le disk!
         *
         * @param filename Chemin complet du fichier ! (sinon répertoire courant)
         * @param input Flux du fichier...
         * @exception IOException Si une erreur d'écriture survient.
         */
      ...
      /**
       * Méthode getFile, récupère les fichiers attaché au message
       *
       * @param pop_message     Objet Message passé en paramètre
      ...
      /**
       * Méthode qui le corps d'un message multipart...
       *
      ...
      /**
       * Méthode getFile, récupère les fichiers attachés au message avec un ContentType définie
       *
       * @param pop_message         Objet Message passé en paramètre
      ...
      /**
       * Méthode qui récupère les fichiers attachés au message avec un ContentType définie
       * (exemple : images 'image/jpeg' contenu dans un mail html avec images embarquées...)
       *
       * @param multipart             Objet multipart
       * @param contentType            String contenant un Content Type
       * @exception                 MessagingException, IOException Si une erreur survient.
      ...
      /**
       * Méthode getBody, récupère le corps du mail sans les headers
       *
       * @param pop_message     Objet Message passé en paramètre
       * @exception Exception       Exception Si une erreur survient.
       *
      ...
      /**
       * Méthode qui récupère le corps d'un message multipart...
       *
       * @param multipart          Objet multipart
       * @exception          MessagingException, IOException Si une erreur survient.
      ...
      public static String getBobyHandlePart(Part part) throws MessagingException, IOException
      {
        ...
        else throw new MessagingException("No text/plain in the message!");
      ...
      /**
       * Méthode getBodyHtml, récupère le corps du mail en html
       *
       * @param pop_message     Objet Message passé en paramètre
       * @exception Exception      Exception Si une erreur survient.
       *
      ...
      /**
       * Méthode qui récupère content type spécifique d'un message multipart...
       * (retourne uniquement un String, pour par exemple récupérer le corp en HTML)
       *
       * @param multipart        Objet multipart
      ...
      /**
       * Méthode qui récupère le corps d'un mail
       *
      ...
      public static BufferedReader getTextReader(Part part) throws MessagingException
      {
        try
        {
          ...
          try { inReader = new InputStreamReader(xis, xjcharset); }
          catch ( UnsupportedEncodingException ex ) { inReader = null; }
          catch ( IllegalArgumentException ex ) { inReader = null; }
      ...
      /**
       * Méthode qui sauve un objet Message au format .elm
       *
       * @param mess
       * @param file_dest
       * @throws MessagingException
      ...
      public static void saveELM(MimeMessage mess, File file_dest) throws MessagingException, IOException
      {
          ...
          if ("".equals(message_id)) message_id = ""+getMessageID(); // pas de Message-ID ???
      ...
      /**
       * Retourne un objet Long représentant un Message-ID
       */
      ...
      /**
       * Méthode qui lit un fichier texte .eml et retourne qui un objet MimeMessage
       *
       * @param  String             chemin fichier .eml
       * @return MimeMessage         objet
       * @throws MessagingException Si un problème de convertion à la lecture du fichier arrive
       * @throws IOException
       */
      ...
      /**
       * Méthode qui encode le Message-ID pour être compatible
       * avec un nom de fichier Window ou Unix (enlève certains méta caractères)
       *
       * @param str
       * @return Le message ID encodé
       */
  ...
  public final static class FileBinary
  {
    ...
    public String getFile() { return c_file; }
    ...
    private void attach(String c_file)
    {
      ...
      {
        try { c_raf.close(); } catch (Exception h) {}
      }
    }
    ...
    private String tohexString(byte abyte0[], int i, int j)
    {
        ...
        {
            int k;
            if (abyte0[l + j] < 0) k = abyte0[l + j] + 256;
            else k = abyte0[l + j];
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      ...
      // début lecture d'un fichier eml (texte)
      /*
     ...
     */
      ...
      */
      ...
      for (int i=0, n=pop_message.length; i<n; i++)
      {
        ...
        // sauve le message dans un répertoire dédier...
