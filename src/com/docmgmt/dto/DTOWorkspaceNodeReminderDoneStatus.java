...
public class DTOWorkspaceNodeReminderDoneStatus
{
	public String vWorkspaceId;
	public int iNodeId;
	public int iAttrId;
	public int iUserCode;
	public char cDoneFlag;
	...
	public char getcDoneFlag() {
		return cDoneFlag;
	}
	public void setcDoneFlag(char cDoneFlag) {
		this.cDoneFlag = cDoneFlag;
	}
