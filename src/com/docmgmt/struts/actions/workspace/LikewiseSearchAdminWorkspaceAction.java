...
public class LikewiseSearchAdminWorkspaceAction extends ActionSupport{
	...
	public void getDetailOfWorkspace(){
		...
		if(wsDesc!= null  && !wsDesc.equalsIgnoreCase("-1")){
		...
		{			
			...
			workspaceSummaryDetails=docMgmtImpl.searchWorkspaceList(dto,userMst);
		}
