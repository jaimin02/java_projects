...
<div class="bdycls">
<form name="workspacenodes" method="post"
	action="WorkspaceNodeRights.do" target="attributeFrame"><br>
...
${htmlCode} <input type="hidden" name="nodeId" value=""> <input
	type="hidden" name="checkBoxName"> <input type="hidden"
	name="hworkspaceId" value="${workspaceID}"></form>
</div>
