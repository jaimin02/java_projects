...
************************************************************************************************************/
	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = 'js/tabs/images/tab_right_inactive.gif';
		...
		img.src = 'js/tabs/images/tab_right_active.gif';

		document.getElementById('tabView' + parentId_div + tabIndex).style.display='block';					
		document.getElementById('tabView' + parentId_div + tabIndex).style.height='289px';
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = 'js/tabs/images/tab_right_over.gif';
		}
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab)
	{
		...
		for(var no=0;no<tabTitles.length;no++){
			...
			if(closeButtonArray[no]){
				...
				closeButton.src = 'js/tabs/images/close.gif';
