...
$(document).ready(function() { 
	...
	function validate()
	{
		...
		var LTRCongiguration='<s:property value="LTRSingleDocFooterFormat"/>';
      	...
      	else if(document.masterAdminForm.loginName.value=="")
		{
      	...
      	else if(document.masterAdminForm.loginName.value.includes(" ")){
      		alert("Please enter valid Login Name.Space is not allowed.");
			document.masterAdminForm.loginName.style.backgroundColor="#FFE6F7"; 
     		document.masterAdminForm.loginName.focus();
     		return false;
      	}
   ...
   /*  	else if(document.masterAdminForm.emailAddress.value=="")
     	...
     	else if(document.masterAdminForm.remark.value.length>250)
		{
     	...
     	else if(document.masterAdminForm.roleCode.value=="-1" && LTRCongiguration == "No")
		{
...
function checkLoginId(loginId){
	var flag=false;
	$.ajax({		
		  url: "loginIdCheck_ex.do?loginId="+loginId,
...
function checkLoginName(loginName){
	var flag=false;
	$.ajax({		
		  url: "loginNameCheck_ex.do?loginName="+loginName,
		  success: function(data) 
		  {
			 // alert(data);
			 if(data=="true")
 ...
 function openlinkEdit(loginName)
 {
		...
		<table style="width: 100%">
			...
			<tr>
				<td class="title" align="right" width="50%"
					style="padding: 2px; padding-right: 8px;">Username<span style="font-size:20px;color:red">*</span></td>
				<td align="left">
...
-->
			...
			<%--  <tr>
				<td class="title" align="right" width="50%"
					style="padding: 2px; padding-right: 8px;">User Type<span style="font-size:20px;color:red">*</span></td>
				<td align="left">
			...
			<tr>
				<td class="title" align="right" width="50%"
					style="padding: 2px; padding-right: 8px;">Profile Name<span style="font-size:20px;color:red">*</span></td>
				<td>
				<!--<s:select list="getUserGroupDtl" headerKey="-1"
					headerValue="Select UserGroup"
					name="usergrouplist" listKey="userGroupCode"
					listValue="userGroupName">
				</s:select>-->
			...
			<tr>
			<s:if test='LTRSingleDocFooterFormat == "Yes"'>
				<td class="title" align="right" width="50%"
			...
			<s:else>
			<td class="title" align="right" width="50%"
					style="padding: 2px; padding-right: 8px;">User Role<span style="font-size:20px;color:red">*</span></td>
				<td align="left"><s:select list="roleDtl" headerKey="-1"
					headerValue="Select Role" name="roleCode"
					listKey="roleCode" listValue="roleName">
					</s:select>
			...
			<tr>
				<td class="title" align="right" width="50%"
					style="padding: 2px; padding-right: 8px;">Location Name<span style="font-size:20px;color:red">*</span></td>
			...
			<tr>
				<td class="title" align="right" width="50%"
					style="padding: 2px; padding-right: 8px;">Reason for Change<span style="font-size:20px;color:red">*</span></td>
...
<table id="usertable" width="100%" align="center" class="datatable">
	...
	<tbody>
		<s:iterator value="userdata" status="status">
			...
			<s:if test="#session.usertype != 'WA' || userType != 'SU'">
				...
				<s:if test ="#session.countryCode != 'IND'">
					...
					<%-- <s:if test="statusIndi != 'D' && blockedFlag!=true && userGroupName != 'IT' ">
						...
						<div align="center"><a title="Edit"
							href="javascript:void(0);"
							onclick="openlinkEdit('<s:property value="loginName" />','<s:property value="userCode" />');">
