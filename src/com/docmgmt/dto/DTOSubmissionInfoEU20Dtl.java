...
public class DTOSubmissionInfoEU20Dtl implements Serializable{
    ...
    List<DTOSubmissionInfoEU20SubDtl> cmsDtls;
	...
	public List<DTOSubmissionInfoEU20SubDtl> getCmsDtls() {
		return cmsDtls;
	}

	public void setCmsDtls(List<DTOSubmissionInfoEU20SubDtl> cmsDtls) {
