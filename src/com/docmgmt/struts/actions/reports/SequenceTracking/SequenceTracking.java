package com.docmgmt.struts.actions.reports.SequenceTracking;
...
public class SequenceTracking extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		workspaceMstList = docMgmtImpl.getAllWorkspace();
	...
	public String Search() {
		...
		if (selectedProjectList != null && selectedProjectList.length() > 0) {
		...
		if (wsIdsList != null && wsIdsList.size() > 0)
	...
	public String GetWorkspaces() {
		...
		Vector<DTOWorkSpaceMst> workspaceMstList = docMgmtImpl
				.searchWorkspaceByProjectType(dtoWsMst, userMst,
						projectTypeList);
		...
		for (int itrOption = 0; itrOption < workspaceMstList.size(); itrOption++) {
			...
			htmlContent += "<option id=\"" + dtoWsMst.getWorkSpaceId() + "##"
					+ dtoWsMst.getLocationCode() + "##"
					+ dtoWsMst.getClientCode() + "\" value=\""
					+ dtoWsMst.getWorkSpaceId() + "##"
					+ dtoWsMst.getLocationCode() + "##"
					+ dtoWsMst.getClientCode()
					+ "\" style=\"display: block;\">";
