...
import com.docmgmt.server.webinterface.beans.ProjectSnapshotBeanTable;
import com.opensymphony.xwork2.ActionContext;
import com.opensymphony.xwork2.ActionSupport;

public class ShowProjectSnapshotTableAction extends ActionSupport {
	...
	public String execute(){
		...
		if(workSpaceId != null && !workSpaceId.equals("") && !workSpaceId.equals("-1")){
			...
			short reportType = ProjectSnapshotBeanTable.TABLE_HTML;
			isTableView=true;
			/*htmlContent ="<div style=\"width:100%;\">"+
			 			 ...
			 			 "</div><br/><br/>";*/
			if(isTableView){
				reportType = ProjectSnapshotBeanTable.TABLE_HTML;
				
				htmlContent = 
						"<div style=\"width:100%; \" align=\"right\"> " +
							"<form id=\"myform\" action=\"ExportToXls.do\" method=\"post\" >"+
								"<input type=\"hidden\" name=\"fileName\" value=\"Project_Attribute_Snapshot_Report.xls\">"+
			...
			ProjectSnapshotBeanTable projectSnapshotBeanTable = new ProjectSnapshotBeanTable();
			htmlContent += "<div id=\"divTabText\" style=\"width:100%\">";
			String htmlContentTemp = projectSnapshotBeanTable.getWorkspaceHtml(workSpaceId, userGroupCode, userCode,reportType,mode);
	...
	public String ShowAttrHistory() {
		...
		ProjectSnapshotBeanTable ProjectSnapshotBeanTable = new ProjectSnapshotBeanTable();
		htmlContent = ProjectSnapshotBeanTable.getAttrHistoryTable(workSpaceId, nodeId, attrId);
