...
import com.opensymphony.xwork2.ActionSupport;
	...
	public class ManualSignatureAction extends ActionSupport{
		...
		public String execute() throws NumberFormatException, SQLException, IOException {
			...
			File checkSignPdf =new File(nodeRec[9]+previousHistory.get(0).getFolderName()+"/"+ fNameWithOutExt+"_Sign.pdf");
			
			if(checkSignPdf.exists()){
				...
				String fname="";
				if(dto.size()>0){
					fname = baseworkFolder+dto.get(0).getBaseWorkFolder()+"/"+fNameWithOutExt +"_Sign.pdf";
