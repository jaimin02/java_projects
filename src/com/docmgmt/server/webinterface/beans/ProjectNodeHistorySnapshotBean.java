...
public class ProjectNodeHistorySnapshotBean { 
	...
	public ProjectNodeHistorySnapshotBean(){ 
		...
		if(workspaceTreeVector.size() > 0){
			...
			*/
			 if(reportType == TABLE_HTML){
				...
				htmlDataStringBuffer.append("<div style\"width:100%;border:1px solid;\" class=\"grid_clr\"><TABLE class=\"report\" border=\"1px\" width='100%' cellspacing=\"0\" style=\"border:0px solid black; word-break: break-word;\">");
				...
				if(countryCode.equalsIgnoreCase("IND")){
					htmlDataStringBuffer.append("<TR align=\"left\" class=\"title\"><TH width=\"15%\">"+lbl_nodeName+"</TH><TH width=\"9.07%\">"+lbl_folderName+"</TH>" +
							"<TH width=\"5.7%\">Status</TH><TH width=\"5.3%\">Sent for</TH><TH width=\"9.65%\">Modified by</TH><TH width=\"8.1%\">User Role</TH>"
							+ "<TH width=\"8.75%\">User Profile</TH><TH width=\"9.9%\">Modified on</TH>"
							+ "<TH width=\"7.85%\">Voided by</TH><TH width=\"7.95%\">Voided on</TH><TH width=\"8.05%\">Reason for Change</TH><TH width=\"11%\">Reason For Void</TH>");
					htmlDataStringBuffer.append("</TR>"); 
				}
					else{
						htmlDataStringBuffer.append("<TR align=\"left\" class=\"title\"><TH width=\"17%\">"+lbl_nodeName+"</TH><TH width=\"9%\">"+lbl_folderName+"</TH>" +
								"<TH width=\"5.95%\">Status</TH><TH width=\"5.7%\">Sent for</TH><TH width=\"7.5%\">Modified by</TH><TH width=\"8.05%\">User Role</TH><TH width=\"5%\">User Profile</TH>"
								+ "<TH width=\"7.9%\">Modified on</TH><TH width=\"8%\">Eastern Standard Time</TH><TH width=\"6.05%\">Voided by</TH><TH width=\"6.95%\">Voided on</TH>"
								+ "<TH width=\"8.1%\">Eastern Standard Time</TH><TH width=\"7.9%\">Reason for Change</TH><TH width=\"9.8%\">Reason For Void</TH>");
						htmlDataStringBuffer.append("</TR>");
					}
	...
	private ArrayList<DTOWorkSpaceNodeHistory> filterListForLeafAttrs(Vector<?> nodeAttrList){
		...
		for (Object dtoObject : nodeAttrList) {
			...
			if(dtoObject instanceof DTOWorkSpaceNodeHistory){
				...
				tempDtoNodeDtl.setUserDefineVersionId(dtoNodeAttr.getUserDefineVersionId());
				...
				tempDtoNodeDtl.setRemark(dtoNodeAttr.getRemark());
				...
				tempDtoNodeDtl.setCurrentSeqNumber(dtoNodeAttr.getCurrentSeqNumber());
				tempDtoNodeDtl.setRoleName(dtoNodeAttr.getRoleName());
				tempDtoNodeDtl.setVoidRemark(dtoNodeAttr.getVoidRemark());
	...
	private StringBuffer getTableChildStructure(Integer nodeId, TreeMap<Integer, ArrayList<Integer>> childNodeHS, Hashtable<Integer, Object[]> nodeDtlHS){
		...
		if(!countryCode.equalsIgnoreCase("IND")){
		   tableHtml.append("<TD  colspan=\"13\" style=\"padding-top:2px;padding-bottom:2px;\" valign=\"middle\">");
			...
			tableHtml.append("<TD  colspan=\"11\" style=\"padding-top:2px;padding-bottom:2px;\" valign=\"middle\">");
		}
		}
		...
		if(mode == 2){//For mode 2 get node attrs from history for the effectiveTranNo.
			...
			//leafNodeAttrs = docMgmtImpl.getNodeAttrDetail(dtows.getWorkSpaceId(), nodeId);
			if(nodeName.length()!=0){
				leafNodeAttrss = docMgmtImpl.showFullNodeHistoryForCSV(dtows.getWorkSpaceId(), nodeId);
			String userTypeName="";
			String fileName="";
			...
			int stageId=0;
			String fileType="";
			String tempFileVersionId = "", tempUserDefineVer = "", stageDesc="";//tempRemark="";
			char tempLastClosed = 'N';
			String voidBy="",voidOn="",voidedRemark,voidESTDateTime="",roleName;
			...
			for (Iterator<DTOWorkSpaceNodeHistory> iterator = leafNodeAttrss
				...
				/*if (dtoHistory.getFileVersionId().equals("")) {
					...
					dtoHistory.setStageId(stageId);
					dtoHistory.setFileType(fileType);
					...
					stageId = dtoHistory.getStageId();
					fileType = dtoHistory.getFileType();
					stageDesc = dtoHistory.getStageDesc();
					voidBy= dtoHistory.getVoidBy();
					voidOn = dtoHistory.getVoidISTDateTime();
					voidESTDateTime = dtoHistory.getVoidESTDateTime();
					roleName=  dtoHistory.getRoleName();
					voidedRemark = dtoHistory.getVoidRemark();
	...
	private StringBuffer createNodeAttrTRsForTable(ArrayList<DTOWorkSpaceNodeHistory> attrList) {
		...
		if(attrList.size()>0){
				...
				for (Iterator<DTOWorkSpaceNodeHistory> iterator = attrList.iterator(); iterator.hasNext();) {
					...
					if(dtoWorkSpaceNodeAttrDetail.getNodeId()==112)
						System.out.println(dtoWorkSpaceNodeAttrDetail.getNodeId());
					String countryCode = ActionContext.getContext().getSession().get("countryCode").toString();
					tableHtml.append("<tr class=\""+((isOddRow)?"odd":"even")+"\">");
			if(countryCode.equalsIgnoreCase("IND")){
						if(userTypeName.equalsIgnoreCase("Inspector")  && !dtoWorkSpaceNodeAttrDetail.getFileName().equalsIgnoreCase("No File") &&(dtoWorkSpaceNodeAttrDetail.getFileName().endsWith(".pdf") || dtoWorkSpaceNodeAttrDetail.getFileName().endsWith(".PDF"))){
							tableHtml.append("<TD valign=\"middle\" width=\"9%\"><a style=\"text-decoration: underline;color:blue;\" href = \"openfile.do?fileWithPath="+dtoWorkSpaceNodeAttrDetail.getBaseWorkFolder()+dtoWorkSpaceNodeAttrDetail.getFolderName()+"/"+dtoWorkSpaceNodeAttrDetail.getFileName()+"\" target=\"_blank\">"+ dtoWorkSpaceNodeAttrDetail.getFileName()+"</a></TD>");
							//tableHtml.append("<TD valign=\"middle\" width=\"10.9%\"><a style=\"text-decoration: underline;color:blue;\" onclick=\"return fileopen('openfile.do?fileWithPath="+dtoWorkSpaceNodeAttrDetail.getBaseWorkFolder()+dtoWorkSpaceNodeAttrDetail.getFolderName()+"/"+dtoWorkSpaceNodeAttrDetail.getFileName()+"');\">"+ dtoWorkSpaceNodeAttrDetail.getFileName()+"</a></TD>");
						}else
						   {
							if(!dtoWorkSpaceNodeAttrDetail.getFileName().equalsIgnoreCase("No File")){
							tableHtml.append("<TD valign=\"middle\" width=\"9%\"><a style=\"text-decoration: underline;color:blue;\" href = \"openfile.do?fileWithPath="+dtoWorkSpaceNodeAttrDetail.getBaseWorkFolder()+dtoWorkSpaceNodeAttrDetail.getFolderName()+"/"+dtoWorkSpaceNodeAttrDetail.getFileName()+"\" target=\"_blank\">"+ dtoWorkSpaceNodeAttrDetail.getFileName()+"</a></TD>");
							}
							else {
								tableHtml.append("<TD valign=\"middle\" width=\"9%\" style=\"color:blue\">No File</TD>");
							}
						   }
			}else{
					if(userTypeName.equalsIgnoreCase("Inspector")  && !dtoWorkSpaceNodeAttrDetail.getFileName().equalsIgnoreCase("No File") &&(dtoWorkSpaceNodeAttrDetail.getFileName().endsWith(".pdf") || dtoWorkSpaceNodeAttrDetail.getFileName().endsWith(".PDF"))){
						tableHtml.append("<TD valign=\"middle\" width=\"10.6%\"><a style=\"text-decoration: underline;color:blue;\" href = \"openfile.do?fileWithPath="+dtoWorkSpaceNodeAttrDetail.getBaseWorkFolder()+dtoWorkSpaceNodeAttrDetail.getFolderName()+"/"+dtoWorkSpaceNodeAttrDetail.getFileName()+"\" target=\"_blank\">"+ dtoWorkSpaceNodeAttrDetail.getFileName()+"</a></TD>");
						//tableHtml.append("<TD valign=\"middle\" width=\"11.5%\"><a style=\"text-decoration: underline;color:blue;\" onclick=\"return fileopen('openfile.do?fileWithPath="+dtoWorkSpaceNodeAttrDetail.getBaseWorkFolder()+dtoWorkSpaceNodeAttrDetail.getFolderName()+"/"+dtoWorkSpaceNodeAttrDetail.getFileName()+"');\">"+ dtoWorkSpaceNodeAttrDetail.getFileName()+"</a></TD>");
					}else
					   {
						if(!dtoWorkSpaceNodeAttrDetail.getFileName().equalsIgnoreCase("No File")){
						tableHtml.append("<TD valign=\"middle\" width=\"10.6%\"><a style=\"text-decoration: underline;color:blue;\" href = \"openfile.do?fileWithPath="+dtoWorkSpaceNodeAttrDetail.getBaseWorkFolder()+dtoWorkSpaceNodeAttrDetail.getFolderName()+"/"+dtoWorkSpaceNodeAttrDetail.getFileName()+"\" target=\"_blank\">"+ dtoWorkSpaceNodeAttrDetail.getFileName()+"</a></TD>");
							...
							tableHtml.append("<TD valign=\"middle\" width=\"10.6%\" style=\"color:blue\">No File</TD>");
						}
					   }
			}
					
					//String attrValue = dtoWorkSpaceNodeAttrDetail.getStageDesc();
					String fileType = dtoWorkSpaceNodeAttrDetail.getFileType();
					int stageId = dtoWorkSpaceNodeAttrDetail.getStageId();
					String stageDesc = dtoWorkSpaceNodeAttrDetail.getStageDesc();
										
					String nextStage="-";	
					
					if(stageId==10 && !fileType.equalsIgnoreCase("SR")){
						stageDesc="Uploaded";
					}
					
					if(stageId==10 && fileType==null){
						nextStage="-";
					}
					else if(stageId==10 && fileType.equalsIgnoreCase("SR")){
						nextStage="Review";
					}
					else if(stageId==20){
						nextStage="Approve";
					...
					if(stageDesc!=null )
						stageDesc = stageDesc.replaceAll("\r\n","<br>").replaceAll("\t","&#9;").replaceAll("'","&#39;");
					else
						stageDesc = "";
					/*tableHtml.append("<TD valign=\"middle\" width=\"13%\">"+((attrValue.length() == 0)? "<font color=\"red\">No Value</font>":attrValue) +"</TD>");
					tableHtml.append("<TD valign=\"middle\" width=\"25%\">"+((dtoWorkSpaceNodeAttrDetail.getModifyOn() !=null && dtoWorkSpaceNodeAttrDetail.getModifyBy() != 1 )?dateFormat.format(dtoWorkSpaceNodeAttrDetail.getModifyOn()):"-") +"</TD>");
					tableHtml.append("<TD valign=\"middle\" width=\"25%\">"+((dtoWorkSpaceNodeAttrDetail.getModifyBy() != 0 && dtoWorkSpaceNodeAttrDetail.getModifyBy() != 1)?allUsers.get(dtoWorkSpaceNodeAttrDetail.getModifyBy()).getUserName():"-")+"</TD>");
					tableHtml.append("<TD valign=\"middle\" width=\"15%\">"+((!dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber().equals("") && dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber()!=null)?"'"+dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber()+"'":"-")+"</TD>");
					tableHtml.append("</tr>");*/
					
					if(countryCode.equalsIgnoreCase("IND")){
						//tableHtml.append("<TD valign=\"middle\" width=\"9%\">"+dtoWorkSpaceNodeAttrDetail.getUserDefineVersionId() +"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"5.8%\">"+((stageDesc.length() == 0)? "<font color=\"red\">No Value</font>":stageDesc) +"</TD>");
						
						//tableHtml.append("<TD valign=\"middle\" width=\"25%\">"+((dtoWorkSpaceNodeAttrDetail.getModifyOn() !=null && dtoWorkSpaceNodeAttrDetail.getModifyBy() != 1 )?dateFormat.format(dtoWorkSpaceNodeAttrDetail.getModifyOn()):"-") +"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"5.5%\">"+nextStage+"</TD>");	
						
						tableHtml.append("<TD valign=\"middle\" width=\"9.9%\">"+((dtoWorkSpaceNodeAttrDetail.getModifyBy() != 0 && dtoWorkSpaceNodeAttrDetail.getModifyBy() != 1)?allUsers.get(dtoWorkSpaceNodeAttrDetail.getModifyBy()).getUserName():"-")+"</TD>");
						//tableHtml.append("<TD valign=\"middle\" width=\"10%\">"+((dtoWorkSpaceNodeAttrDetail.getModifyBy() != 0 && dtoWorkSpaceNodeAttrDetail.getModifyBy() != 1)?allUsers.get(dtoWorkSpaceNodeAttrDetail.getModifyBy()).getUserName()+"["+stageDesc+"]":"-")+"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"8.3%\">"+dtoWorkSpaceNodeAttrDetail.getRoleName() +"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"9%\">"+dtoWorkSpaceNodeAttrDetail.getUserTypeName() +"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"10.2%\">"+ISTDateTime+"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"8%\">"+dtoWorkSpaceNodeAttrDetail.getVoidBy()+"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"8.2%\">"+dtoWorkSpaceNodeAttrDetail.getVoidISTDateTime()+"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"8.2%\">"+((!dtoWorkSpaceNodeAttrDetail.getRemark().equals("") && dtoWorkSpaceNodeAttrDetail.getRemark()!=null)?dtoWorkSpaceNodeAttrDetail.getRemark():"-")+"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"4.5%\">"+((dtoWorkSpaceNodeAttrDetail.getVoidRemark()!=null && !dtoWorkSpaceNodeAttrDetail.getVoidRemark().equals("") && dtoWorkSpaceNodeAttrDetail.getVoidRemark()!=null)?dtoWorkSpaceNodeAttrDetail.getVoidRemark():"-")+"</TD>");
						
						//tableHtml.append("<TD valign=\"middle\" width=\"8%\">"+((!dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber().equals("") && dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber()!=null)?"'"+dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber()+"'":"-")+"</TD>");
						
						tableHtml.append("</tr>");
						
						}
						else{
							//tableHtml.append("<TD valign=\"middle\" width=\"10%\">"+dtoWorkSpaceNodeAttrDetail.getUserDefineVersionId() +"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"7.2%\">"+((stageDesc.length() == 0)? "<font color=\"red\">No Value</font>":stageDesc) +"</TD>");
							
							//tableHtml.append("<TD valign=\"middle\" width=\"25%\">"+((dtoWorkSpaceNodeAttrDetail.getModifyOn() !=null && dtoWorkSpaceNodeAttrDetail.getModifyBy() != 1 )?dateFormat.format(dtoWorkSpaceNodeAttrDetail.getModifyOn()):"-") +"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"6.9%\">"+nextStage+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"9.1%\">"+((dtoWorkSpaceNodeAttrDetail.getModifyBy() != 0 && dtoWorkSpaceNodeAttrDetail.getModifyBy() != 1)?allUsers.get(dtoWorkSpaceNodeAttrDetail.getModifyBy()).getUserName():"-")+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"9.8%\">"+dtoWorkSpaceNodeAttrDetail.getRoleName() +"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"6.1%\">"+dtoWorkSpaceNodeAttrDetail.getUserTypeName() +"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"9.5%\">"+ISTDateTime+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"9.8%\">"+ESTDateTime+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"7.2%\">"+dtoWorkSpaceNodeAttrDetail.getVoidBy()+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"8.5%\">"+dtoWorkSpaceNodeAttrDetail.getVoidISTDateTime()+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"10%\">"+dtoWorkSpaceNodeAttrDetail.getVoidESTDateTime()+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"15.5%\">"+((!dtoWorkSpaceNodeAttrDetail.getRemark().equals("") && dtoWorkSpaceNodeAttrDetail.getRemark()!=null)?dtoWorkSpaceNodeAttrDetail.getRemark():"-")+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"10.1%\">"+((dtoWorkSpaceNodeAttrDetail.getVoidRemark()!=null && !dtoWorkSpaceNodeAttrDetail.getVoidRemark().equals("") && dtoWorkSpaceNodeAttrDetail.getVoidRemark()!=null)?dtoWorkSpaceNodeAttrDetail.getVoidRemark():"-")+"</TD>");
							//tableHtml.append("<TD valign=\"middle\" width=\"22%\">"+((!dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber().equals("") && dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber()!=null)?"'"+dtoWorkSpaceNodeAttrDetail.getCurrentSeqNumber()+"'":"-")+"</TD>");
							tableHtml.append("</tr>");
						}
