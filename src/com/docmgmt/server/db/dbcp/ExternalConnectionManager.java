...
public class ExternalConnectionManager {
	...
	private static final Log LOG = LogFactory.getLog(ExternalConnectionManager.class);
	 ...
	 */
	public ExternalConnectionManager(ExternalConfiguration config) {
		try {
			if (ds == null)
				connectToDB(config);
		} catch (Exception e) {
	 ...
	 */
	private void connectToDB(ExternalConfiguration config) {
		...
		try {
			ExternalConnectionManager.ds = setupDataSource(config.getDbURI(), config
	...
	public static DataSource setupDataSource(String connectURI,
		...
		ExternalConnectionManager._pool = connectionPool;
	...
	public static void printDriverStats() throws Exception {
		ObjectPool connectionPool = ExternalConnectionManager._pool;
