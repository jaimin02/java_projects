...
public class ProjectTackingSnapshotBean { 
	...
	public ProjectTackingSnapshotBean(){ 
		...
		if(workspaceTreeVector.size() > 0){
			...
			*/
			 if(reportType == TABLE_HTML){
				...
				htmlDataStringBuffer.append("<tr class=\"none\"><Td class=\"title\"style=\"display:none\"> Project Name : " +dtows.getWorkSpaceDesc()+"</Td></tr></table><br/>");
/*				htmlDataStringBuffer.append("<tr class=\"none\"><Td class=\"title\" width=\"40%\" align='right'  ><font size=\"4\"> Project Name : </Td>");
				...
				htmlDataStringBuffer.append("<div class=\"grid_clr\" style\"width:100%;border:1px solid;\"><TABLE class=\"report\" border=\"1px\" width='100%' cellspacing=\"0\" style=\"word-break: break-all; border:0px solid black\">");
				...
				if(countryCode.equalsIgnoreCase("IND")){
					htmlDataStringBuffer.append("<TR align=\"left\" class=\"title\"><TH width=\"10.5%\">"+lbl_nodeName+"/"+lbl_folderName+"</TH>" +
							"<TH width=\"10%\">Assigned User</TH><TH width=\"8.3%\">Stage Assigned</TH><TH width=\"6%\">Sent for</TH>"
							+ "<TH width=\"8%\">Status</TH><TH width=\"8%\">User Role</TH><TH width=\"9%\">User Profile</TH><TH width=\"10%\">Modified on</TH>"
							+ "<TH width=\"10.5%\">Voided by</TH><TH width=\"10%\">Voided on</TH>");
					htmlDataStringBuffer.append("</TR>");
				}
				else{
					htmlDataStringBuffer.append("<TR align=\"left\" class=\"title\"><TH width=\"10.5%\">"+lbl_nodeName+"/"+lbl_folderName+"</TH>" +
							"<TH width=\"8.5%\">Assigned User</TH><TH width=\"6%\">Stage Assigned</TH><TH width=\"5.6%\">Sent for</TH>"
							+ "<TH width=\"7.6%\">Status</TH><TH width=\"8%\">User Role</TH><TH width=\"8.3%\">User Profile</TH><TH width=\"9%\">Modified on</TH>"
							+ "<TH width=\"9%\">Eastern Standard Time</TH><TH width=\"8%\">Voided by</TH><TH width=\"8%\">Voided on</TH>"
							+ "<TH width=\"17%\">Eastern Standard Time</TH>");
					htmlDataStringBuffer.append("</TR>");
				}
	...
	private StringBuffer getTableChildStructure(Integer nodeId, TreeMap<Integer, ArrayList<Integer>> childNodeHS, Hashtable<Integer, Object[]> nodeDtlHS){
		...
		if(nodeName.length()!=0){
			tableHtml.append("<TR class=\"none\">");
		tableHtml.append("<TD align='left' width=\"20%\" class=\"title\" valign=\"middle\" >"+nodeName+"</TD>");
	...
	private StringBuffer createNodeAttrTRsForTable(ArrayList<DTOWorkSpaceNodeHistory> attrList) {
		...
		if(attrList.size()>0){
				...
				for (Iterator<DTOWorkSpaceNodeHistory> iterator = attrList.iterator(); iterator.hasNext();) {
					...
					if(countryCode.equalsIgnoreCase("IND")){					
						tableHtml.append("<TD valign=\"middle\" width=\"12.2%\">"+((!dtoWorkSpaceNodeAttrDetail.getUserName().equals("") && dtoWorkSpaceNodeAttrDetail.getUserName()!=null)?dtoWorkSpaceNodeAttrDetail.getUserName():"-")+"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"10.5%\">"+ dtoWorkSpaceNodeAttrDetail.getStageDesc() +"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"7.6%\">"+nextStage +"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"10.1%\">"+Status+"</TD>");
						if(Status.equalsIgnoreCase("Sign Off Completed"))
							tableHtml.append("<TD valign=\"middle\" width=\"10.1%\">"+dtoWorkSpaceNodeAttrDetail.getRoleName()+"</TD>");
						else
							tableHtml.append("<TD valign=\"middle\" width=\"10.1%\">-</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"11.4%\">"+dtoWorkSpaceNodeAttrDetail.getUserTypeName() +"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"12.6%\">"+ISTDateTime+"</TD>");	
						tableHtml.append("<TD valign=\"middle\" width=\"13.3%\">"+dtoWorkSpaceNodeAttrDetail.getVoidBy()+"</TD>");
						tableHtml.append("<TD valign=\"middle\" width=\"14%\">"+dtoWorkSpaceNodeAttrDetail.getVoidISTDateTime()+"</TD>");
						tableHtml.append("</tr>");
						}
						else{
							tableHtml.append("<TD valign=\"middle\" width=\"9.9%\">"+((!dtoWorkSpaceNodeAttrDetail.getUserName().equals("") && dtoWorkSpaceNodeAttrDetail.getUserName()!=null)?dtoWorkSpaceNodeAttrDetail.getUserName():"-")+"</TD>");						
							tableHtml.append("<TD valign=\"middle\" width=\"7.5%\">"+ dtoWorkSpaceNodeAttrDetail.getStageDesc() +"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"6.7%\">"+ nextStage +"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"9.1%\">"+Status+"</TD>");
							if(Status.equalsIgnoreCase("Sign Off Completed"))
								tableHtml.append("<TD valign=\"middle\" width=\"9.6%\">"+dtoWorkSpaceNodeAttrDetail.getRoleName()+"</TD>");
							else 
								tableHtml.append("<TD valign=\"middle\" width=\"10.1%\">-</TD>"); 
							tableHtml.append("<TD valign=\"middle\" width=\"10%\">"+dtoWorkSpaceNodeAttrDetail.getUserTypeName() +"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"10.8%\">"+ISTDateTime+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"10.9%\">"+ESTDateTime+"</TD>");	
							tableHtml.append("<TD valign=\"middle\" width=\"9.6%\">"+dtoWorkSpaceNodeAttrDetail.getVoidBy()+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"9.7%\">"+dtoWorkSpaceNodeAttrDetail.getVoidISTDateTime()+"</TD>");
							tableHtml.append("<TD valign=\"middle\" width=\"14%\">"+dtoWorkSpaceNodeAttrDetail.getVoidESTDateTime()+"</TD>");
							tableHtml.append("</tr>");
						}
