...
<script type="text/javascript">
	...
	function getProjectSnapshot(reportType){
		...
		var urlOfAction="ShowProjectTracking_ex.do?mode="+mode;//mode=1  for latest  
	...
	{	
		...
		$.ajax(
		{			
			url: 'ShowProjectTracking_ex.do?workSpaceId=' + workSpaceId+'&mode='+mode,
			beforeSend: function()
			{
					$('#ProjectSnapshotDiv').html("<img src=\"images/loading.gif\" alt=\"loading ...\" />");								
			},
...
<div align="center"><img
	src="images/Header_Images/Report/Project-Tracking_Snapshot.jpg"
...
<div class="boxborder"><div class="all_title"><b style="float:left">Project Tracking</b></div></div><!-- <img
...
<table width="100%">
	<tr>
		<td class="title" align="right" width="50%" style="padding: 2px; padding-right: 8px;">Project</td>
		<td><s:select id="workSpaceId" name="workSpaceId"
			list="getWorkspaceDetail" listKey="workSpaceId"
			listValue="workSpaceDesc" onchange="getProjectSnapshot('TreeView')"
			ondblclick="getProjectSnapshot('TreeView')">
		</s:select></td>
	</tr>
</table>
