...
<table style="width: 100%; padding-bottom: 5px;" cellspacing="0px">
	<tr id="lblcomment">
		<th id="th1"
			...
			style="cursor: pointer;">Inbox <s:property value="dispType" />
		</label></th>
		<s:if test="nodeId==0 && WorkspaceId==null">
		<th id="th2"
			...
			<table class="datatable" align="center"
				...
				<s:iterator value="allComments" status="status">
					<tr id="row<s:property value='#status.count'/>"
						...
						<%-- <td><s:date name="createdOn" format="yyyy-MM-dd hh:mm a" /></td> --%>
					...
					<s:if test ="#session.countryCode != 'IND'">
						...
						<s:else>
							...
							alt="Show Comments" src="images/Common/show_comment.png" height="18px" width="18px"
			...
			<table class="datatable" style="width: 100%; border: 0px;"
				...
				<s:iterator value="sentComments" status="status">
					<tr id="srow<s:property value='#status.count'/>" class="even">
						...
						<td><s:date name="createdOn" format="dd-MMM-yyyy HH:mm" /></td>
						<td>
						<img align="right" border="0px" title="Show Commnets"
