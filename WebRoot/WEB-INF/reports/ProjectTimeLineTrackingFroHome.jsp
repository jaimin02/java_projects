...
<script type="text/javascript">
	...
	{	
		...
		$.ajax(
		{			
			url: 'ProjectTimelineTracking_ex.do?workSpaceId=' + workSpaceId+'&mode=0',
			beforeSend: function()
			{
					$('#ProjectSnapshotDiv').html("<img src=\"images/loading.gif\" alt=\"loading ...\" />");								
			},
...
<div class="boxborder"><div class="all_title"><b style="float:left">Project Timeline Tracking Report</b></div></div><!-- <img
