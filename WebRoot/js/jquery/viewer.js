 ...
 * Javascript code in this page
 */
var timoutNow = 300000;// 10000 ; // Timeout in 5min/10 Sec
var timeoutTimer = 0;
...
/***/ (function (module, exports, __webpack_require__) {
    ...
    // Add this event for reset when scroll in document
    var seconds = timoutNow / 1000;
    var timeoutTimer = setTimeout(function () { window.parent.IdleTimeout(); }, timoutNow);

    function ResetTimers() {
        clearTimeout(timeoutTimer);
        seconds = timoutNow / 1000;
        setTimeout(timeoutTimer, timoutNow);
    }

    setInterval(function () {
        if (seconds == 2) {
            setTimeout(function () { window.parent.IdleTimeout() }, 100);
        }
        seconds--;
    }, 1000);
