package com.docmgmt.struts.actions.labelandpublish.EU14;
...
public class WorkspacePublishService_EU14 {
	...
	public WorkspacePublishService_EU14() {
	...
	public void workspacePublish(String workspaceId,
		...
		try {
			...
			if (projectPublishType == 'P') {
				...
				System.out.println("Label="+labelNo);
				...
				for(int i1=0;i1<AllNodesofHistory.size();i1++){
					
					
					System.out.println("===>"+AllNodesofHistory.get(i1));
			...
			if(utilPath.exists())
			{
				...
				System.out.println("==> "+allNodesDtl.get(i));
	...
	public void getChildNode(Vector childNodes, String pathToCreate,
		...
		if (childNodes.size() == 0) {
			...
			if (AllNodesofHistory.contains(nodeId) && nodeId!=145) {
	...
	private void writeToXmlFile(String stype, PublishAttrForm publishForm)
		...
		if (stype.equals("eu")) {
			...
			String XmldtdVersionDeclaration = "<eu:eu-backbone xmlns:eu=\"http://europa.eu.int\" xmlns:xlink=\"http://www.w3c.org/1999/xlink\" dtd-version=\"2.0\">";
