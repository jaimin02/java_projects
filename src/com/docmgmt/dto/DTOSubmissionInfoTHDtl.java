...
public class DTOSubmissionInfoTHDtl {
	...
	public String getSubmissionInfoTHDtlId() {
		return submissionInfoTHDtlId;
	}
	public void setSubmissionInfoTHDtlId(String submissionInfoTHDtlId) {
		this.submissionInfoTHDtlId = submissionInfoTHDtlId;
	}
