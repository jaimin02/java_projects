package com.docmgmt.struts.actions.labelandpublish.TH;
...
public class WorkspacePublishService_TH {
	...
	public WorkspacePublishService_TH() {
		...
		if (childNodes.size() == 0) {
			...
			if (AllNodesofHistory.contains(nodeId)) {
				...
				if (childAttrId.size() != 0) {
					...
					if (pathToCreate.matches(".*/m1/th/.*-cover.*")) {
					...
					for (int i = 0; i < childAttrId.size(); i++) {
						...
						if (attrName.equalsIgnoreCase("operation")
							...
							for (int j = 0; j < modifiedFile.size(); j++) {
								...
								if (pathToCreate.contains("m1/th")) {
									query.append("../../../");
									query.append("" + lastPubVersion + "");

									query.append("/m1/th/th-regional.xml#");
								} else {
									query.append("../");
									query.append("" + lastPubVersion + "");
	...
	private void writeToXmlFile(String stype, PublishAttrForm publishForm)
		...
		if (stype.equals("th")) {
			...
			String xslStyleSheetDeclaration = "<?xml-stylesheet href=\"../../util/style/th-regional.xsl\" type=\"text/xsl\"?>";
			
			//String xslStyleSheetDeclaration = "<?xml-stylesheet type=\"text/xsl\" href=\"../../util/style/au-regional.xsl\"?>";
			
			String XmldtdVersionDeclaration = "<th_ectd schema-version=\"1.0\"  xmlns=\"th_ectd\"  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  xsi:schemaLocation=\"th_ectd ../../util/dtd/th-regional.xsd\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" >";
			...
			out.write("<esub-id>"
					...
					+ "</esub-id>");
			out.write("\n");
			out.write("<sequence-type>" + publishForm.getSequenceType()+"</sequence-type>");
			
			out.write("\n");
			out.write("<reg-activity-lead>" + publishForm.getRegActLead()+"</reg-activity-lead>");
			...
			out.write("\n");
			out.write("<licensee>" + publishForm.getLicensee()+"</licensee>");
			out.write("\n");
			out.write("<licensee-name>" + publishForm.getLicenseeName()+"</licensee-name>");
			
			out.write("\n");
			out.write("<licensee-type>" + publishForm.getLicenseeType()+"</licensee-type>");
			
			String[] inn_th = publishForm.getInn().split("#");
			...
			out.write("\n");
			out.write("<sequence>" + publishForm.getSeqNumber()
					+ "</sequence>");
			if (publishForm.getRelatedSeqNumber() != null
				...
				out.write("\n");
				out.write("<related-sequence>0000</related-sequence>");
			}
			out.write("\n");
			out.write("<seq-description>" + publishForm.getSequenceDescription()
					+ "</seq-description>");
			out.write("\n" + "<email>"+publishForm.getEmail()+"</email>");
			
			out.write("\n" + "</envelope>");// End of envelopes
		}

		else if (stype.equals("thm2-m5")) {
			...
			String thmd5 = md5.getMd5HashCode(absolutePathToCreate + "/m1/th"
					+ "/th-regional.xml");
			System.out
					.println("CheckSum ="
							+ "<leaf xml:lang=\"en\" checksum-type=\"md5\" modified-file=\"\" operation=\"new\" application-version=\"\" xlink:href=\"m1/th/th-regional.xml\" checksum=\""
							+ thmd5
			...
			out
					.write("<leaf xml:lang=\"en\" checksum-type=\"md5\" operation=\"new\" application-version=\"\" xlink:href=\"m1/th/th-regional.xml\" checksum=\""
							+ thmd5
							+ "\" ID=\"node-999\" xlink:type=\"simple\">");
			out.write("<title>");
			out.write("TH Module 1");
