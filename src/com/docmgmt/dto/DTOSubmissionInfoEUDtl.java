...
public class DTOSubmissionInfoEUDtl implements Serializable{
    ...
    List<DTOSubmissionInfoEUSubDtl> cmsDtls;
	...
	public List<DTOSubmissionInfoEUSubDtl> getCmsDtls() {
		return cmsDtls;
	}
	public void setCmsDtls(List<DTOSubmissionInfoEUSubDtl> cmsDtls) {
