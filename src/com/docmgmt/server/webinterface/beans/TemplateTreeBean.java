...
*/			
	...
	private StringBuffer getChildStructure(Integer nodeId, TreeMap childNodeHS, Hashtable nodeDtlHS) {
		...
		if(childList.size() > 0){
            ...
            htmlStringBuffer.append("<IMG id='folder" + nodeId.intValue() + "' src=\"images/closed.gif\">" + "<a  href=\"templateNodeAttribute.do?requestId="+ ClientRequestID.WORKSPACE_NODE_RIGHTS +"&nodeId="+nodeId+"&displayName="+displayName+"&leaf=\"yes\"\" target=\"attributeFrame\" >" + NodeName.replaceAll(" ","&nbsp;") + "</a><BR>\n");
...
//            }else if(getUserType().equalsIgnoreCase("WA")) {
            	htmlStringBuffer.append("<IMG  src=\"images/empty.gif\"><a  href=\"templateNodeAttribute.do?requestId="+ ClientRequestID.WORKSPACE_NODE_RIGHTS +"&nodeId="+nodeId+"&displayName="+displayName+"&leaf=\"yes\"\" target=\"attributeFrame\" >" + NodeName.replaceAll(" ","&nbsp;") + "</a><BR>\n");
//            }
		}
