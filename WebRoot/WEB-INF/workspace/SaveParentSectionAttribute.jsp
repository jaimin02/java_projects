...
//var userType;
	...
	$(document).ready(function() { 
		...
		if(ScriptCodeAutoGenrate=='Yes'){
			document.getElementById('Script Code').value = '<s:property value="scriptCode"/>';
...
<div style="border: 1px; border-radius: 10px 10px 0px 0px; border-color: #5A8AA9; border-style: solid; padding-bottom: 15px; border-top: none;"
	align="center">
	<div class="boxborder"><div class="all_title"><b style="float:left;">Add Attribute Detail</b></div>
<br>

</div>
<br>

<s:form action="RepeatParentSection" method="post" id="addUsertoProjectForm" name="addUsertoProjectForm" >
...
<div id="err"><s:if test="errorMsg==null || errorMsg == ''">&nbsp;</s:if>
		<s:else>
			...
			<s:else>
				...
				<tr>
					<td colspan="2" align="center"><s:submit value="Save"
						cssClass="button" onclick="return validate();"></s:submit>&nbsp;&nbsp; <input type="button"
