...
public class DTOSubmissionInfovNeeSDtl implements Serializable{
	...
	public String getSubmissionInfovNeeSDtlId() {
		return submissionInfovNeeSDtlId;
	}

	public void setSubmissionInfovNeeSDtlId(String submissionInfovNeeSDtlId) {
		this.submissionInfovNeeSDtlId = submissionInfovNeeSDtlId;
	}
