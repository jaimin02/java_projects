...
<SCRIPT type="text/javascript">
			...
			$(document).ready(function() { 
				...
				$('#EmpRpt').submit(function(){
					$('#EMPRptDiv').html("<img src=\"images/loading.gif\" alt=\"loading ...\" />");								
...
<div
	...
	align="center"><br>
<div align="left"><s:form name="EmpRpt" id="EmpRpt"
	action="getEmpRpt_ex">
	<table align="center" width="100%" cellspacing="0">
		<tr>
			<td class="title" align="right" width="25%"
				style="padding: 2px; padding-right: 6px;">Employee&nbsp;</td>
			<td align="left"><s:select list="empList" headerKey="-999"
				headerValue="All Employee" listKey="empNo"
				listValue="%{empName  + ' (' +  empCode + ')'}" id="empNo"
				name="empNo" theme="simple"></s:select></td>
		</tr>
		<tr>
...
<br />
<div align="center" id="EMPRptDiv"></div>
<br />
</div>
</div>
</div>
