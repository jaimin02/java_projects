...
public class GetWorkspaceAction extends ActionSupport{
	...
	public String getFailProjectScriptDetail(){
		...
		getFailScriptDeatil = new Vector<DTOWorkSpaceNodeAttrDetail>(); 
		getFailScriptDeatil = docMgmtImpl.getProjectFailScriptDetail(workSpaceId);
		return SUCCESS;
	}

	public Vector<DTOWorkSpaceMst> getWorkspaceDetail;
	public Vector<DTOAttributeMst> getSelectedAttrDetail;
	public Vector<DTOWorkSpaceNodeAttrDetail> getFailScriptDeatil;
		
	public Vector<DTOWorkSpaceNodeAttrDetail> getGetFailScriptDeatil() {
		return getFailScriptDeatil;
	}
	public void setGetFailScriptDeatil(Vector<DTOWorkSpaceNodeAttrDetail> getFailScriptDeatil) {
		this.getFailScriptDeatil = getFailScriptDeatil;
	}
