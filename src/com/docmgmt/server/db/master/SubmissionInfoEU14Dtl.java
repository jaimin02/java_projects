...
public class SubmissionInfoEU14Dtl {
	
	
	DataTable datatable;
	public SubmissionInfoEU14Dtl()
	{
		 datatable=new DataTable();
	}

public String insertSubmissionInfoEU14Dtl(DTOSubmissionInfoEU14Dtl dto,int DATAOPMODE)
{
	...
	{		
		...
		Connection con = ConnectionManager.ds.getConnection();
			...
			proc = con.prepareCall("{ Call Insert_SubmissionInfoEU14Dtl(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
						
			proc.setString(1,dto.getSubmissionInfoEU14DtlId());
			...
			if(rs.next()) {
				submissionInfoEU14DtlId = rs.getString(1);
			}
			proc.close();
...
public Vector<DTOSubmissionInfoEU14Dtl> getWorkspaceSubmissionInfoEU14Dtl(String workspaceId)
{
		...
		try
		{
			...
			rs = datatable.getDataSet(con,"*","View_SubmissionInfoEU14Dtl" , "WorkspaceId='"+workspaceId+"'", "");
			while(rs.next())
			{
				DTOSubmissionInfoEU14Dtl dto = new DTOSubmissionInfoEU14Dtl();
				dto.setSubmissionInfoEU14DtlId(rs.getString("SubmissionInfoEU14DtlId"));
...
public DTOSubmissionInfoEU14Dtl getWorkspaceSubmissionInfoEU14DtlBySubmissionId(String submissionId)
{
	...
	DTOSubmissionInfoEU14Dtl dto = new DTOSubmissionInfoEU14Dtl();
		try
		{
			...
			rs = datatable.getDataSet(con,"*","View_SubmissionInfoEU14Dtl" , "SubmissionInfoEU14DtlId='"+submissionId+"'", "");
			if(rs.next())
			{
				dto.setSubmissionInfoEU14DtlId(rs.getString("SubmissionInfoEU14DtlId"));
				dto.setWorkspaceId(rs.getString("WorkspaceId"));
