...
<script type="text/javascript">
	...
	function getProjectSnapshot(reportType){
		...
		var urlOfAction="ShowProjectAttributeSnapshot_ex.do?mode="+mode;//mode=1  for latest  
	...
	{	
		...
		$.ajax(
		{			
			url: 'ShowProjectAttributeSnapshot_ex.do?workSpaceId=' + workSpaceId+'&mode='+mode,
			beforeSend: function()
			{
					$('#ProjectSnapshotDiv').html("<img src=\"images/loading.gif\" alt=\"loading ...\" />");								
			},
...
<div align="center"><img
	src="images/Header_Images/Report/Project_Attribute_Snapshot.jpg"
